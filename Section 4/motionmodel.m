classdef motionmodel
    ...
    methods (Static)
        function obj = cvmodel(T,sigma)
            ...
            %       obj.f: function handle return state prediction --- 4 x
            %       1 vector 
        ...
        function obj = ctmodel(T,sigmaV,sigmaOmega)
            %CTMODEL creates a 2D coordinate turn model with nearly
            %constant polar velocity and turn rate 
            %INPUT: T: sampling time --- scalar
            ...
            %       turn rate --- scalar 
            %OUTPUT:obj.d: object state dimension --- scalar
            %       obj.F: function handle return a motion Jacobian matrix
            %       --- 5 x 5 matrix 
            %       obj.f: function handle return state prediction --- 5 x
            %       1 vector 
